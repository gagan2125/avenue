...
export default function OrganizeCustomers() {
  ...
  // For active count, if customers have a "status" field, filter accordingly.
  ...
  useEffect(() => {
    ...
    setOragnizerId(storedOrganizerId || null);
  }, []);

  // New fetch function using the new endpoint:
  const fetchCustomers = async () => {
    if (!oragnizerId) return;
    setFetchLoading(true);
    try {
      // New endpoint call – adjust according to your backend route.
      const response = await axios.get(`${url}/customers/${oragnizerId}`);
      // Assuming response.data is an array of customer objects with keys:
      // customerName, email, phoneNumber, ticketsBought
    ...
    <SidebarLayout>
        ...
        fetchLoading ? (
          ...
          <div className="text-white p-6 max-w-7xl mx-auto @container grid gap-9">
            <div className="grid gap-3">
              ...
              <p className="text-white/70">Manage your customers</p>
            </div >
            ...
            <div className="grid @4xl:grid-cols-2 gap-4 h-fit">
              <div className="border border-white/10 p-4 rounded-xl h-full flex flex-col gap-y-3">
                <h2 className="font-medium text-white/70 text-sm">Total customers</h2>
                <p className="text-2xl font-medium">{uniqueCustomers.length || 0}</p>
              </div>
              <div className="border border-white/10 p-4 rounded-xl h-full flex flex-col gap-y-3">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    filteredCustomers.map((customer, index) => (
                              ...
                              >
                                <td className="py-4 pl-4">{customer.customerName}</td>
                                 <td className="py-4 pl-4">{customer.email}</td>
                                <td className="py-4 pl-4">{customer.phoneNumber || "-"}</td>
                                <td className="py-4 pl-4">
                          {customer.ticketsBought || 0} tickets
                        </td>
                                <td className="py-4 pl-4">
                                  <DirectionAwareMenu>
                                    <MenuTrigger>
        ...
        <DialogContent className="max-h-[90vh] !gap-0">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-y-3 bg-white/[0.03] border-b rounded-t-xl border-white/10 p-6">
              ...
              <DialogDescription>
                Add a new customer to your team.
              </DialogDescription>
            </div>
      ...
      >
        <DialogContent className="flex flex-col gap-3 p-6">
          ...
          <DialogDescription>
            This customer will no longer be able to access events and permanently deleted from your account.
        ...
        <DialogContent className="flex flex-col gap-3 p-6">
          ...
          <div className="flex flex-col gap-3 mt-3">
            ...
            >
              ...
              {selectedMember?.status === 'active' ? "Deactivate" : "Activate"} customer
            </button>
          </div>
        </DialogContent>
      </Dialog>
        ...
        showAddNotification && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm">Customer added successfully</p>
            </div>
            <button
        ...
        showEditNotification && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm">Customer edited successfully</p>
            </div>
            <button
        ...
        showActivateNotification && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm">Customer status changed successfully</p>
            </div>
            <button
        ...
        showDeleteNotification && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm">Customer deleted successfully</p>
            </div>
            <button
        ...
        showAssignNotification && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm">Customer events updated successfully</p>
            </div>
            <button
